...
//v2 changes to improve clock appearance when used as a Wear OS clock face:
//correction to remove background flicker, increases to font, hands and second dot sizes, 
//numerals moved away from edge
